#!/usr/bin/env python3
"""G1-R2 K7 reward combinations: binary 0.25, pairwise 0.50, three seeds, 113 steps."""
import argparse
...
RECIPES = {
    'k7-binary025': 'Binary025',
    'k7-pairwise050': 'Pairwise050',
    'k7-binary025-pairwise050': 'Binary025-Pairwise050',
}
...
def main():
    ...
    parser.add_argument('--recipes', nargs='+', choices=list(RECIPES), default=list(RECIPES),
                        help='Recipes to run (default: all three K7 combinations)')
    ...
    runs = [f'G1-R2-RL-GradedNDCG64-CP-Align070-ShortlistUniform-K7-T1-{RECIPES[recipe]}'
    ...
    run_simple_baselines(ROOT / 'configs/experiments/iclr2027/suite_g1_shortlist_combinations.yaml',
