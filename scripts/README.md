...
| `eval_iclr2027_gpt_reasoning_06b.py` / `eval_iclr2027_gpt_reasoning_4b.py` | 论文主表两种 backbone 的 BRIGHT GPT-reasoning query 评测；各复用 E0 和三种方法的 checkpoint，共 10 次只评测；见[说明](../docs/iclr2027_bright_gpt_reasoning_eval.md) |
...
| `run_g2_rl_r2_k0.py` | 从 `Qwen/Qwen3-0.6B` 直接训练单条 E2Rank RL，采用当前 G1 K=0 + pairwise 主配方；支持预检、训练和最终 MTEB 补评，见[实验说明](../docs/g2_r2_k0_direct_rl.md) |
